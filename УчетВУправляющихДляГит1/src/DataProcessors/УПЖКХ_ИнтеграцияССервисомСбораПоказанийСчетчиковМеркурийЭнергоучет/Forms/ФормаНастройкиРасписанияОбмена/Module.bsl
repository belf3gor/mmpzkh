...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СистемаСбораПоказанийСчетчиков") Тогда
		Объект.СистемаСбораПоказанийСчетчиков = Параметры.СистемаСбораПоказанийСчетчиков;
	Иначе
...
Процедура УстановитьВидимостьЭлементовРасписания()
	...
	Попытка
		...
		УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПодготовитьРегламентноеЗаданиеПроизводителиСчетчиков(РегламентноеЗадание, ВыполнятьОбменПоРасписанию, Объект.СистемаСбораПоказанийСчетчиков);
...
Функция ПолучитьРасписание()
	...
	Возврат УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПолучитьРасписаниеПроизводителиСчетчиков(РегламентноеЗадание, Объект.СистемаСбораПоказанийСчетчиков);
