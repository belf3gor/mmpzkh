...
Процедура УправлениеСтраницейНастройкиРасписанияАвтоматическогоОбмена(Форма)
	...
	Элементы.РасписаниеРегламентногоЗадания.Доступность = ВидНастройкиРасписанияОбмена = 0;
	Элементы.РасписаниеРегламентногоЗадания.Видимость   = ВидНастройкиРасписанияОбмена = 1;
...
Функция ПолучитьРасписаниеОбмена()
	...
	Возврат УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПолучитьРасписаниеПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.НЦРЭ);
...
Процедура СохранитьНастройкиИнтеграции()
	...
	УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.УстановитьНастройкиИнтеграцииCСервисамиОбменаПоказанийСчетчиков(СтруктураНастроек, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.НЦРЭ);
...
Процедура КомандаИзменитьРасписаниеОбмена(Команда)
	...
	ОткрытьФорму("Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковНЦРЭ.Форма.ФормаНастройкиРасписанияОбмена",, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура КомандаВыполнитьРазовыйОбменДанными(Команда)
	...
	НазваниеСистемы = УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.ПолучитьСтроковоеПредставлениеТекущейСистемыДляРегламентныхЗаданий(ПредопределенноеЗначение("Перечисление.УПЖКХ_СистемыСбораПоказанийСчетчиков.НЦРЭ"));
...
Процедура КомандаОткрытьЖурналОбмена(Команда)
	...
	ОткрытьФорму("Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковНЦРЭ.Форма.ФормаИсторииОбменов" ,, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура УстановитьВидимостьЭлементовРасписания()
	...
	Попытка
		...
		УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПодготовитьРегламентноеЗаданиеПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, ВыполнятьОбменПоРасписанию, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.НЦРЭ);
...
Процедура КомандаПечатьЛистовки(Команда)
	...
	Праметры = Новый Структура("ИмяОбъекта", "Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковНЦРЭ");
...
Процедура КомандаОткрытьСтраницуСОписанием(Команда)
	...
	ЗапуститьПриложение("https://vgkh.ru/jsk/jkh/sistemy-sbora-pokazanij/ncre/");
...
Процедура КомандаОткрытьФАК(Команда)
	...
	ЗапуститьПриложение("https://vgkh.ru/faq-1s-zhkh/rabota_s_priborami_ucheta_3_0/integraciya-ncre/");
