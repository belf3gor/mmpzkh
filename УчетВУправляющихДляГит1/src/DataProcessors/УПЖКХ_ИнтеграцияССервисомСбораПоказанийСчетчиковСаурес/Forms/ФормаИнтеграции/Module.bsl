...
Процедура ПерейтиНаСтраницуЗавершенияНастройки()
	...
	Если МассивПодстрок.Количество() >= 5 Тогда
		...
		Элементы.НадписьЗавершениеНастройки.Заголовок = Новый ФорматированнаяСтрока(Новый ФорматированнаяСтрока(МассивПодстрок[0],,),
																					...
																					Новый ФорматированнаяСтрока(МассивПодстрок[3], , , , "https://vgkh.ru/jsk/jkh/saures"),
...
Процедура ЗаполнитьНастройки()
	...
	СохраненныеНастройки = УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.ПолучитьНастройкиИнтеграцииССервисамиСбораПоказанийСчетчиков(Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес);
...
Процедура СохранитьНастройкиИнтеграции()
	...
	УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.УстановитьНастройкиИнтеграцииCСервисамиОбменаПоказанийСчетчиков(СтруктураНастроек, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес);
...
Процедура ИнициализироватьНастройкиРегламентногоЗадания()
	...
	УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.УстановитьПараметрыРегламентногоЗаданияПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, 
																											 УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.ПолучитьСтроковоеПредставлениеТекущейСистемыДляРегламентныхЗаданий(Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес));
...
Процедура УстановитьВидимостьЭлементовРасписания()
	...
	Попытка
		...
		УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПодготовитьРегламентноеЗаданиеПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, ВыполнятьОбменПоРасписанию, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес);
...
Функция ПолучитьРасписаниеОбмена()
	...
	Возврат УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПолучитьРасписаниеПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес);
...
Процедура КомандаИзменитьРасписаниеОбмена(Команда)
	...
	ОткрытьФорму("Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковСаурес.Форма.ФормаНастройкиРасписанияОбмена",, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура КомандаВыполнитьРазовыйОбменДанными(Команда)
	...
	НазваниеСистемы = УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.ПолучитьСтроковоеПредставлениеТекущейСистемыДляРегламентныхЗаданий(ПредопределенноеЗначение("Перечисление.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес"));
...
Процедура КомандаОткрытьЖурналОбмена(Команда)
	...
	ОткрытьФорму("Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковСаурес.Форма.ФормаИсторииОбменов" ,, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	
КонецПроцедуры

&НаКлиенте
// Обработчик команды "ПечатьЛистовки".
Процедура КомандаПечатьЛистовки(Команда)
	
	Праметры = Новый Структура("ИмяОбъекта", "Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковСаурес");
...
Процедура КомандаОткрытьСтраницуСОписанием(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("КомандаОткрытьСтраницуСОписаниемЗапускПриложения", ЭтотОбъект);
	
	НачатьЗапускПриложения(ОписаниеОповещения, УПЖКХ_ИнформацияОРазработчикеИПрограмме.АдресСтраницыСервисЗагрузкиДанныхИзСистемСбораПоказанийСчетчиков());
	
КонецПроцедуры

&НаКлиенте
// Обработчик завершения запуска приложения.
Процедура КомандаОткрытьСтраницуСОписаниемЗапускПриложения(КодВозврата, ДополнительныеПараметры) Экспорт
...
Процедура КомандаОткрытьФАК(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("КомандаОткрытьФАКЗапускПриложения", ЭтотОбъект);
	
	НачатьЗапускПриложения(ОписаниеОповещения, УПЖКХ_ИнформацияОРазработчикеИПрограмме.АдресСтраницыИнтеграциясОблакомКомпанииSaures());
	
КонецПроцедуры

&НаКлиенте
// Обработчик завершения запуск приложения.
Процедура КомандаОткрытьФАКЗапускПриложения(КодВозврата, ДополнительныеПараметры) Экспорт
