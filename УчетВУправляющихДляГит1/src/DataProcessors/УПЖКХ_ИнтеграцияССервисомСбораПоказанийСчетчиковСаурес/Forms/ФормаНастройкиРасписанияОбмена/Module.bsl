...
Процедура УстановитьВидимостьЭлементовРасписания()
	...
	Попытка
		...
		УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПодготовитьРегламентноеЗаданиеПроизводителиСчетчиков(РегламентноеЗадание, ВыполнятьОбменПоРасписанию, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес);
...
Функция ПолучитьРасписание()
	...
	Возврат УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПолучитьРасписаниеПроизводителиСчетчиков(РегламентноеЗадание, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Саурес);
