...
Процедура СохранитьНастройкиИнтеграции()
	...
	УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.УстановитьНастройкиИнтеграцииCСервисамиОбменаПоказанийСчетчиков(СтруктураНастроек, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Болид);
...
Процедура УстановитьВидимостьЭлементовРасписания()
	...
	Попытка
		...
		УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПодготовитьРегламентноеЗаданиеПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, ВыполнятьОбменПоРасписанию, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Болид);
...
Функция ПолучитьРасписаниеОбмена()
	...
	Возврат УПЖКХ_ОбщиеМеханизмыИнтеграцииСоСтороннимиСистемами.ПолучитьРасписаниеПроизводителиСчетчиков(РегламентноеЗаданиеОбмена, Перечисления.УПЖКХ_СистемыСбораПоказанийСчетчиков.Болид);
...
Процедура КомандаИзменитьРасписаниеОбмена(Команда)
	...
	ОткрытьФорму("Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковБолид.Форма.ФормаНастройкиРасписанияОбмена",, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура КомандаВыполнитьРазовыйОбменДанными(Команда)
	...
	НазваниеСистемы = УПЖКХ_ИнтеграцияССервисамиСбораПоказанийСчетчиковВзаимодействиеСБазойДанных.ПолучитьСтроковоеПредставлениеТекущейСистемыДляРегламентныхЗаданий(ПредопределенноеЗначение("Перечисление.УПЖКХ_СистемыСбораПоказанийСчетчиков.Болид"));
...
Процедура КомандаОткрытьЖурналОбмена(Команда)
	...
	ОткрытьФорму("Обработка.УПЖКХ_ИнтеграцияССервисомСбораПоказанийСчетчиковБолид.Форма.ФормаИсторииОбменов" ,, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура КомандаОткрытьСтраницуСОписанием(Команда)
	...
	ЗапуститьПриложение("https://vgkh.ru/jsk/jkh/bolid/");
...
Процедура КомандаОткрытьФАК(Команда)
	...
	ЗапуститьПриложение("https://vgkh.ru/faq-1s-zhkh/rabota_s_priborami_ucheta_3_0/integratsiya-s-oblakom-kompanii-bolid/");
