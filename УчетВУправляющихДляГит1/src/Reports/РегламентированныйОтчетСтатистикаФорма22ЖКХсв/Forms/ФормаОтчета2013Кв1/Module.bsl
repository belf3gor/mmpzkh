...
Процедура ЗаполнитьАвто(Отказ)
		...
		Для Каждого СтрокаОбъема ИЗ ТаблицаОбъемов Цикл
			...
			ИначеЕсли СтрокаОбъема.ВидУслуги = "Отопление" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаОбъема.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004006003"].Значение = ТабДокумент.Области["П000004006003"].Значение + СтрокаОбъема.Количество;
			...
			ИначеЕсли СтрокаОбъема.ВидУслуги = "Электроэнергия" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаОбъема.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004005903"].Значение = ТабДокумент.Области["П000004005903"].Значение + СтрокаОбъема.Количество;
	...
	Если УслугиНастройкиУказаны ИЛИ УслугиЖилищныеНастройкиУказаны Тогда
		...
		ТабДокумент.Области["П000002002503"].Значение = СуммаДолгаЖилищные;
		ТабДокумент.Области["П000002002603"].Значение = СуммаДолгаЖилищные;
		ТабДокумент.Области["П000002002903"].Значение = СуммаДолгаЖилищные;
		...
		ТабДокумент.Области["П000002002504"].Значение = СуммаДолгаВодоснабжение;
		ТабДокумент.Области["П000002002604"].Значение = СуммаДолгаВодоснабжение;
		ТабДокумент.Области["П000002002904"].Значение = СуммаДолгаВодоснабжение;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002505"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002605"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002905"].Значение = СуммаДолга;
		КонецЕсли;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002506"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002606"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002906"].Значение = СуммаДолга;
		КонецЕсли;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002507"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002607"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002907"].Значение = СуммаДолга;
		КонецЕсли;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002508"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002608"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002908"].Значение = СуммаДолга;
		КонецЕсли;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002509"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002609"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002909"].Значение = СуммаДолга;
		КонецЕсли;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002510"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002610"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002910"].Значение = СуммаДолга;
		КонецЕсли;
		...
		Если НЕ НайденнаяСтрока = Неопределено Тогда
			...
			ТабДокумент.Области["П000002002511"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002611"].Значение = СуммаДолга;
			ТабДокумент.Области["П000002002911"].Значение = СуммаДолга;
		КонецЕсли;
	...
	Если УслугиНастройкиУказаны ИЛИ УслугиЖилищныеНастройкиУказаны Тогда
		...
		|					ГДЕ
		|						втДействующиеЛицевыеСчета.Помещение.ВидПомещения В (&ВидыЖилыхПомещений))
		...
		|	ЕСТЬNULL(втПлощадиПомещений.Площадь, 0) * втДолиЛицевыхСчетов.Доля КАК Площадь
		...
		Для Каждого СтрокаСведений ИЗ ТаблицаСведений Цикл
			...
			Если СтрокаСведений.ВидУслуги = "Наем" Тогда
				...
				ТабДокумент.Области["П000003003803"].Значение = ТабДокумент.Области["П000003003803"].Значение + СтрокаСведений.СуммаНачисления;
				ТабДокумент.Области["П000003003804"].Значение = ТабДокумент.Области["П000003003803"].Значение + СтрокаСведений.СуммаОплаты;
				ТабДокумент.Области["П000003003810"].Значение = ТабДокумент.Области["П000003003810"].Значение + СтрокаСведений.Площадь;
				ТабДокумент.Области["П000003003811"].Значение = ТабДокумент.Области["П000003003811"].Значение + СтрокаСведений.КоличествоПроживающих;
				
			ИначеЕсли СтрокаСведений.ВидУслуги = "СодержаниеИРемонт" Тогда
				
				// раздел 3, строка 39, графы 3, 4, 10, 11
				ТабДокумент.Области["П000003003903"].Значение = ТабДокумент.Области["П000003003903"].Значение + СтрокаСведений.СуммаНачисления;
				ТабДокумент.Области["П000003003904"].Значение = ТабДокумент.Области["П000003003904"].Значение + СтрокаСведений.СуммаОплаты;
				ТабДокумент.Области["П000003003910"].Значение = ТабДокумент.Области["П000003003910"].Значение + СтрокаСведений.Площадь;
				ТабДокумент.Области["П000003003911"].Значение = ТабДокумент.Области["П000003003911"].Значение + СтрокаСведений.КоличествоПроживающих;
				...
				Если СтрокаСведений.ЕстьБлагоустройства Тогда
					...
					ТабДокумент.Области["П000003004004"].Значение = ТабДокумент.Области["П000003004004"].Значение + СтрокаСведений.СуммаОплаты;
				...
				Иначе
					...
					ТабДокумент.Области["П000003004103"].Значение = ТабДокумент.Области["П000003004103"].Значение + СтрокаСведений.СуммаНачисления;
					ТабДокумент.Области["П000003004104"].Значение = ТабДокумент.Области["П000003004104"].Значение + СтрокаСведений.СуммаОплаты;
					ТабДокумент.Области["П000003004110"].Значение = ТабДокумент.Области["П000003004110"].Значение + СтрокаСведений.Площадь;
					ТабДокумент.Области["П000003004111"].Значение = ТабДокумент.Области["П000003004111"].Значение + СтрокаСведений.КоличествоПроживающих;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "ХолоднаяВода" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаСведений.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004006105"].Значение = ТабДокумент.Области["П000004006105"].Значение + СтрокаСведений.КоличествоПроживающих;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "Водоотведение" Тогда
				...
				ТабДокумент.Области["П000003004603"].Значение = ТабДокумент.Области["П000003004603"].Значение + СтрокаСведений.СуммаНачисления;
				ТабДокумент.Области["П000003004604"].Значение = ТабДокумент.Области["П000003004604"].Значение + СтрокаСведений.СуммаОплаты;
				ТабДокумент.Области["П000003004610"].Значение = ТабДокумент.Области["П000003004610"].Значение + СтрокаСведений.Площадь;
				ТабДокумент.Области["П000003004611"].Значение = ТабДокумент.Области["П000003004611"].Значение + СтрокаСведений.КоличествоПроживающих;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "ГорячаяВода" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаСведений.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004006205"].Значение = ТабДокумент.Области["П000004006205"].Значение + СтрокаСведений.КоличествоПроживающих;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "Отопление" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаСведений.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004006004"].Значение = ТабДокумент.Области["П000004006004"].Значение + СтрокаСведений.Площадь;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "Электроэнергия" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаСведений.Многоквартирное Тогда
					...
					// раздел 3, строки 59, графы 4, 5
					ТабДокумент.Области["П000004005905"].Значение = ТабДокумент.Области["П000004005905"].Значение + СтрокаСведений.КоличествоПроживающих;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "СетевойГаз" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаСведений.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004006305"].Значение = ТабДокумент.Области["П000004006305"].Значение + СтрокаСведений.КоличествоПроживающих;
			...
			ИначеЕсли СтрокаСведений.ВидУслуги = "СжиженныйГаз" Тогда
				...
				Если ОтчетностьЗаГод И СтрокаСведений.Многоквартирное Тогда
					...
					ТабДокумент.Области["П000004006405"].Значение = ТабДокумент.Области["П000004006405"].Значение + СтрокаСведений.КоличествоПроживающих;
		...
		// Округление
		ТабДокумент.Области["П000003003903"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003003903"].Значение);
		ТабДокумент.Области["П000003003904"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003003904"].Значение);
		
		ТабДокумент.Области["П000003003803"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003003803"].Значение);
		ТабДокумент.Области["П000003003804"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003003804"].Значение);
		...
		ТабДокумент.Области["П000003004103"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003004103"].Значение);
		ТабДокумент.Области["П000003004104"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003004104"].Значение);
		...
		ТабДокумент.Области["П000003004603"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003004603"].Значение);
		ТабДокумент.Области["П000003004604"].Значение = ПеревестиВТысячи(ТабДокумент.Области["П000003004604"].Значение);
	...
	ТабДокумент.Области["П000003005801"].Значение = СтруктураРеквизитовФормы.мСоциальнаяНормаНаЧеловека;
