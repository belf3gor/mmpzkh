...
Процедура ПриОткрытии(Отказ)
	...
	// Данный отчет временно не работает, т.к. недоработан механизм по учете управляющих компаний для лицевых счетов.
	ПоказатьПредупреждение(Неопределено, "Данный отчет временно не работает");
	Отказ = Истина;
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Отчет об изменении численности проживающих "
