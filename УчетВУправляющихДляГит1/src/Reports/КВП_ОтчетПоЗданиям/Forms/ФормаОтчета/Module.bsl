...
Процедура ДобавитьПоляВНаборКомпоновкиНаСервере()
	...
	Отчеты.КВП_ОтчетПоЗданиям.ДобавитьПоляВНаборКомпоновки(ПараметрыОтчета,
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// СхемыУчета
	ОТР_СхемыУчетаСервер.ПриСозданииНаСервере(ЭтаФорма, Элементы.ГруппаСхемаУчета);
	// Конец СхемыУчета
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("ГруппироватьЗдания"               , Отчет.ГруппироватьЗдания);
	ПараметрыОтчета.Вставить("Здание"                           , ПараметрЗдание);
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Отчет по зданиям на " + Формат(Отчет.НачалоПериода, "ДФ=dd.MM.yyyy") + " г.";
