...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "17/07/2013";   
...
Процедура ПоказатьПериод()
	...
	СтруктураРеквизитовФормы.СтрПериодОтчета = ?(Месяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 6, "январь - июнь ", "январь - декабрь ") 
											 + Формат(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ=yyyy") + " г.";
