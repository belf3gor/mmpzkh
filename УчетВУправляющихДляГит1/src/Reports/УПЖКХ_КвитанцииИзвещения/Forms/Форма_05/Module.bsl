...
Процедура СохранениеРеквизитов()
	...
	СтруктураПараметров.Вставить("ВыводитьЛьготы",                             Отчет.ВыводитьЛьготы);
	СтруктураПараметров.Вставить("ОтборКвитанций",                             Отчет.ОтборКвитанций);
	СтруктураПараметров.Вставить("ГраницаОтбораИтоговойСуммыОт",               Отчет.ГраницаОтбораИтоговойСуммыОт);
	СтруктураПараметров.Вставить("ГраницаОтбораИтоговойСуммыОтБезОграничений", Отчет.ГраницаОтбораИтоговойСуммыОтБезОграничений);
	СтруктураПараметров.Вставить("ГраницаОтбораИтоговойСуммыДо",               Отчет.ГраницаОтбораИтоговойСуммыДо);
	СтруктураПараметров.Вставить("ГраницаОтбораИтоговойСуммыДоБезОграничений", Отчет.ГраницаОтбораИтоговойСуммыДоБезОграничений);
...
Процедура УстановитьВидимость()
	...
	Элементы.ГруппаГраницыОтбора.Видимость             = Отчет.ОтборКвитанций = ПредопределенноеЗначение("Перечисление.УПЖКХ_ЗначенияОтбораКвитанций.ПечататьКвитанцииСИтоговойСуммойВИнтервале");
...
&НаКлиенте
// Обработчик "ПриИзменении" поля "ОтборКвитанций".
//
...
Процедура СформироватьОтчет(Команда)
	...
	Исключение
		...
		УПЖКХ_РаботаСДиалогамиКлиент.ВывестиСообщениеОбОшибкеВКвитанции(ЭтотОбъект, УПЖКХ_ОбщегоНазначенияКлиентСервер.ПолучитьОписаниеОшибки(ОписаниеОшибки(), "не удалось сформировать квитанцию. Обратитесь за помощью к разработчикам: otr@rarus.ru"));
...
Процедура СравнитьМакетСТиповым(Команда)
	...
	УПЖКХ_РаботаСДиалогамиКлиент.СравнитьТиповойМакетСПользовательским("Отчет.УПЖКХ_КвитанцииИзвещения", "ПФ_MXL_Макет_05");
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("ВыводитьЛьготы",                             Отчет.ВыводитьЛьготы);
	ПараметрыОтчета.Вставить("ОтборКвитанций",                             Отчет.ОтборКвитанций);
	ПараметрыОтчета.Вставить("ГраницаОтбораИтоговойСуммыОт",               Отчет.ГраницаОтбораИтоговойСуммыОт);
	ПараметрыОтчета.Вставить("ГраницаОтбораИтоговойСуммыОтБезОграничений", Отчет.ГраницаОтбораИтоговойСуммыОтБезОграничений);
	ПараметрыОтчета.Вставить("ГраницаОтбораИтоговойСуммыДо",               Отчет.ГраницаОтбораИтоговойСуммыДо);
	ПараметрыОтчета.Вставить("ГраницаОтбораИтоговойСуммыДоБезОграничений", Отчет.ГраницаОтбораИтоговойСуммыДоБезОграничений);
	ПараметрыОтчета.Вставить("ВыводитьНачальноеСальдо",                    Отчет.ВыводитьНачальноеСальдо);
	ПараметрыОтчета.Вставить("НеПечататьНулевыеКвитанции",                 Отчет.ОтборКвитанций = Перечисления.УПЖКХ_ЗначенияОтбораКвитанций.НеПечататьНулевыеКвитанции);
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	Если ИБФайловая Тогда
		...
		Отчеты.УПЖКХ_КвитанцииИзвещения.СформироватьОтчет(ПараметрыОтчета, АдресХранилища);
		РезультатВыполнения = Новый Структура("ЗаданиеВыполнено", Истина);
	Иначе
		РезультатВыполнения = УПЖКХ_ТиповыеМетодыСервер.ЗапуститьВыполнениеВФоне(
			УникальныйИдентификатор,
			"Отчеты.УПЖКХ_КвитанцииИзвещения.СформироватьОтчет",
			ПараметрыОтчета,
...
Процедура УправлениеФормой()
	...
	Элементы.СравнитьМакетСТиповым.Видимость = УПЖКХ_ОбщегоНазначенияКлиентСервер.ОпределитьИспользованиеПользовательскогоМакетаПечати("Отчет.УПЖКХ_КвитанцииИзвещения", "ПФ_MXL_Макет_05");
...
Процедура ОбновитьГраницыОтбораИтоговойСуммы(ИмяПоля = "", ЗначениеОтбора = Неопределено)
	...
	Если ПустаяСтрока(ИмяПоля) Тогда
		...
		Если Отчет.ГраницаОтбораИтоговойСуммыОтБезОграничений Тогда
		...
		Если Отчет.ГраницаОтбораИтоговойСуммыДоБезОграничений Тогда
	...
	Иначе
		...
		Если ЗначениеОтбора = ЗначенияВыбораТипаГраницОтбораКвитанций[0].Значение Тогда // "без ограничений"
			...
			Отчет[ИмяПоля]                        = "без ограничений";
			Отчет[ИмяПоля + "БезОграничений"]     = Истина;
		Иначе // "значение"
			Элементы[ИмяПоля].ОграничениеТипа      = ОграничениеТипаЧисло;
			Элементы[ИмяПоля].РедактированиеТекста = Истина;
			Отчет[ИмяПоля + "БезОграничений"]     = Ложь;
		КонецЕсли;
