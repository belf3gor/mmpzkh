...
Процедура СохранениеРеквизитов()
	...
	// Инициализация структуры с параметрами при первом закрытии.
...
Процедура ПриОткрытии(Отказ)
	...
	Попытка
		...
		ТекущаяФормаКвитанции = Отчет.СписокФормКвитанций.НайтиПоЗначению("01");
...
Процедура СменитьКвитанцию(Команда)
	...
	Отчет.СписокФормКвитанций.ПоказатьВыборЭлемента(ОповещениеОВыборе, "Сменить квитанцию", Отчет.СписокФормКвитанций.НайтиПоЗначению("01"));
...
Процедура СравнитьМакетСТиповым(Команда)
	...
	УПЖКХ_РаботаСДиалогамиКлиент.СравнитьТиповойМакетСПользовательским("Отчет.УПЖКХ_КвитанцииИзвещения", "ПФ_MXL_Макет_01");
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("Форма"						   , "01");
	ПараметрыОтчета.Вставить("ВидЗапроса"					   , "форма_01");
...
Процедура УправлениеФормой()
	...
	Элементы.СравнитьМакетСТиповым.Видимость = УПЖКХ_ОбщегоНазначенияКлиентСервер.ОпределитьИспользованиеПользовательскогоМакетаПечати("Отчет.УПЖКХ_КвитанцииИзвещения", "ПФ_MXL_Макет_01");
