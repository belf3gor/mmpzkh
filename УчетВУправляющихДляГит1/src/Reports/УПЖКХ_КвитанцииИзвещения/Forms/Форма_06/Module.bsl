...
Процедура СохранениеРеквизитов()
	...
	СтруктураПараметров.Вставить("ВыводитьПроцентЗаУслугиБанка",    Отчет.ВыводитьПроцентЗаУслугиБанка);
	СтруктураПараметров.Вставить("ПроцентЗаУслугиБанка",            Отчет.ПроцентЗаУслугиБанка);
...
Процедура УстановитьВидимость()
	...
	Элементы.ПроцентЗаУслугиБанка.Доступность = Отчет.ВыводитьПроцентЗаУслугиБанка;
...
Процедура ПриОткрытии(Отказ)
	...
	Попытка
		...
		ТекущаяФормаКвитанции = Отчет.СписокФормКвитанций.НайтиПоЗначению("06");
...
&НаКлиенте
// Обработчик события "ПриИзменении" поля "ВыводитьПроцентЗаУслугиБанка".
Процедура ВыводитьПроцентЗаУслугиБанкаПриИзменении(Элемент)
...
&НаКлиенте
// Обработчик события "ПриИзменении" поля "ПроцентЗаУслугиБанка".
Процедура ПроцентЗаУслугиБанкаПриИзменении(Элемент)
...
Процедура СменитьКвитанцию(Команда)
	...
	Отчет.СписокФормКвитанций.ПоказатьВыборЭлемента(ОповещениеОВыборе, "Сменить квитанцию", Отчет.СписокФормКвитанций.НайтиПоЗначению("06"));
...
Процедура СравнитьМакетСТиповым(Команда)
	...
	УПЖКХ_РаботаСДиалогамиКлиент.СравнитьТиповойМакетСПользовательским("Отчет.УПЖКХ_КвитанцииИзвещения", "ПФ_MXL_Макет_06");
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("ВыводитьПроцентЗаУслугиБанка"	   , Отчет.ВыводитьПроцентЗаУслугиБанка);
	ПараметрыОтчета.Вставить("ПроцентЗаУслугиБанка"			   , Отчет.ПроцентЗаУслугиБанка);
	...
	ПараметрыОтчета.Вставить("Форма"						   , "06");
	ПараметрыОтчета.Вставить("ВидЗапроса"					   , "форма_06");
...
Процедура УправлениеФормой()
	...
	Элементы.СравнитьМакетСТиповым.Видимость = УПЖКХ_ОбщегоНазначенияКлиентСервер.ОпределитьИспользованиеПользовательскогоМакетаПечати("Отчет.УПЖКХ_КвитанцииИзвещения", "ПФ_MXL_Макет_06");
