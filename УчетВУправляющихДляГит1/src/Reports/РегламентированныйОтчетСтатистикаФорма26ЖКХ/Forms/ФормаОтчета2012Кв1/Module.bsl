...
Процедура Настройка(Команда)
	...
	ОткрытьФорму("Отчет.РегламентированныйОтчетСтатистикаФорма26ЖКХ.Форма.НастройкиОтчета");
...
Процедура ЗаполнитьАвто()
	...
	|	СведенияОЛьготниках.Льготник КАК Льготник,
	|	СведенияОЛьготниках.ЛьготнаяКатегория КАК ЛьготнаяКатегория
	...
	|			И (УПЖКХ_СтепеньРодстваФизЛицСрезПоследних.СтепеньРодства.БлизкоеРодство)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	КоличествоПолучателейЛьготПоКатегориям.КоличествоЛьготников КАК КоличествоЛьготников,
	|	КоличествоПолучателейЛьготПоКатегориям.КоличествоПолучателейЛьгот КАК КоличествоПолучателейЛьгот,
	...
	|	КоличествоПолучателейЛьготПоГруппамКатегорий.ГруппаЛьготныхКатегорий КАК ГруппаЛьготныхКатегорий
	|ИЗ
	...
	Для Каждого СтрокаПолучателейЛьгот ИЗ ТаблицаПолучателейЛьгот Цикл
		...
		Если СтрокаПолучателейЛьгот.ГруппаЛьготныхКатегорий = "ОбязательстваРФ" Тогда
			...
			мФормаОтчета.Области.П000001000203.Значение = СтрокаПолучателейЛьгот.КоличествоПолучателейЛьгот;
			мФормаОтчета.Области.П000001000204.Значение = СтрокаПолучателейЛьгот.КоличествоЛьготников;
			
		ИначеЕсли СтрокаПолучателейЛьгот.ГруппаЛьготныхКатегорий = "ОбязательстваСубъектовРФ" Тогда
			
			// раздел 1, строка 3, графы 3, 4
			мФормаОтчета.Области.П000001000303.Значение = СтрокаПолучателейЛьгот.КоличествоПолучателейЛьгот;
			мФормаОтчета.Области.П000001000304.Значение = СтрокаПолучателейЛьгот.КоличествоЛьготников;
		...
		ИначеЕсли СтрокаПолучателейЛьгот.ГруппаЛьготныхКатегорий = "НПАМестныхОргановСамоуправления" Тогда
			...
			мФормаОтчета.Области.П000001000403.Значение = СтрокаПолучателейЛьгот.КоличествоПолучателейЛьгот;
			мФормаОтчета.Области.П000001000404.Значение = СтрокаПолучателейЛьгот.КоличествоЛьготников;
