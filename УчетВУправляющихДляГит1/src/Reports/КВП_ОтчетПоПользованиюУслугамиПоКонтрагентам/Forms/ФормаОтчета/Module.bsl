...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Пользование услугами "
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	ФорматируемоеПоле = ПолучитьИзВременногоХранилища(СхемаКомпоновкиДанных).НаборыДанных.Начисления.Поля.Найти("Объем");
	ФорматируемоеПоле.Оформление.Элементы.Найти("Формат").Значение = "ЧДЦ=" + Строка(Константы.УПЖКХ_ТочностьОбъемаНачислений.Получить()) + "";
