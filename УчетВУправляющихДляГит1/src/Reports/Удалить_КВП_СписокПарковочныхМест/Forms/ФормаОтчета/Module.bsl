...
Процедура ДобавитьПоляВНаборКомпоновкиНаСервере()
	...
	Отчеты.Удалить_КВП_СписокПарковочныхМест.ДобавитьПоляВНаборКомпоновки(ПараметрыОтчета,
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Отчет.ДатаПросмотра) Тогда
		Отчет.ДатаПросмотра = УПЖКХ_ТиповыеМетодыКлиентСервер.ПолучитьРабочуюДату();
	КонецЕсли;
...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	Отчеты.Удалить_КВП_СписокПарковочныхМест.ПередКомпоновкойМакета(ПодготовитьПараметрыОтчетаНаСервере(),
															ПолучитьИзВременногоХранилища(СхемаКомпоновкиДанных),
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Список парковочных мест на " + Формат(Отчет.ДатаПросмотра, "ДФ=dd.MM.yyyy") + " г.";
