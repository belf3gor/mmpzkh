...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	Попытка
		...
		Отчет.БанковскийСчет = УПЖКХ_ОбщегоНазначенияСервер.ПолучитьЗначениеРеквизита(Отчет.Организация,
																						"ОсновнойБанковскийСчет");
		Отчет.Банк = УПЖКХ_ОбщегоНазначенияСервер.ПолучитьЗначениеРеквизита(Отчет.БанковскийСчет, "Банк");
