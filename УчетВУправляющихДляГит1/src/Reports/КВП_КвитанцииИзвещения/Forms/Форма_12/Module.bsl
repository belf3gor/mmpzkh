...
Процедура ЗаполнитьТаблицуОбщийСписокУслуг()
	...
	ВсеУслуги.Загрузить(Отчеты.КВП_КвитанцииИзвещения.ПолучитьВсеУслуги());
	...
	Если Отчет.ОбщийСписокУслуг.Количество() = 0 
		...
		Отчет.ОбщийСписокУслуг.Загрузить(ВсеУслуги.Выгрузить());
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	Если ИБФайловая Тогда
		...
		Отчеты.КВП_КвитанцииИзвещения.СформироватьОтчетФорма12(ПараметрыОтчета, АдресХранилища);
		РезультатВыполнения = Новый Структура("ЗаданиеВыполнено", Истина);
	Иначе
		РезультатВыполнения = УПЖКХ_ТиповыеМетодыСервер.ЗапуститьВыполнениеВФоне(
			УникальныйИдентификатор,
			"Отчеты.КВП_КвитанцииИзвещения.СформироватьОтчетФорма12",
			ПараметрыОтчета,
