...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Подомовые затраты"
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	ФорматируемоеПоле = ПолучитьИзВременногоХранилища(СхемаКомпоновкиДанных).НаборыДанных.НаборДанных1.Поля.Найти("Количество");
