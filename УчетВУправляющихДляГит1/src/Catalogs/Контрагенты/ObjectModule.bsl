...
Процедура ПередЗаписью(Отказ)
	...
	// В случае, если изменяется наименование контрагента, мы должны проверить, задействован ли этот контрагент
	...
	Если Не ЭтоНовый() И Не ПометкаУдаления И Не Наименование = Ссылка.Наименование Тогда
