...
Процедура ДеревоОбъектовМетаданныхЗаполнить()
	...
	ПараметрыЭлемента.Имя = КВП_ПрочиеПроцедурыИФункции.НаименованиеТиповойКонфигурации(Метаданные.Имя);
	ПараметрыЭлемента.Синоним = КВП_ПрочиеПроцедурыИФункции.СинонимТиповойКонфигурации(Метаданные.Имя);
	// Квартплата -
