...
#Область БлокНастройкиПараметров
...
Процедура ТестУстройства(Команда)
	...
	Если Не Результат Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			"""" + Модель + """: " + ВыходныеПараметры[1] + "(код ошибки " + ВыходныеПараметры[0] + ")");
	КонецЕсли;
...
Процедура ПоследняяВерсияСсылкаНажатие(Элемент)
	...
	УПЖКХ_ОбщегоНазначенияКлиент.ОткрытьСтраницуВБраузере(Элемент.Заголовок);
