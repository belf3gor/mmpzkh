...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Установим видимость команды формирования описания параметров макета.
	УПЖКХ_ХранилищеСтруктурыОписанияПараметров = УПЖКХ_УправлениеПечатьюСервер.ПолучитьОписаниеПараметров(Параметры.ИмяОбъектаМетаданныхМакета);
	Элементы.УПЖКХ_ОписаниеПараметров.Видимость = Не ПустаяСтрока(УПЖКХ_ХранилищеСтруктурыОписанияПараметров);
...
&НаКлиенте
// Процедура обработчик команды "Описание параметров".
//
Процедура ОписаниеПараметров(Команда)
	
	ПараметрКоманды = Новый Массив;
	// Добавляем любую пустую ссылку для того, чтобы не было ошибок в типовых механизмах Пользовательских макетов печати.
	ПараметрКоманды.Добавить(ПредопределенноеЗначение("Справочник.КВП_ЛицевыеСчета.ПустаяСсылка"));
	
	УПЖКХ_ТиповыеМетодыКлиент.ВыполнитьКомандуПечати("ОбщийМодуль.УПЖКХ_УправлениеПечатьюСервер",
	                                                 "ОписаниеПараметров",
	                                                 ПараметрКоманды,
	                                                 Неопределено,
	                                                 Новый Структура("ХранилищеСтруктурыОписанияПараметров,НаименованиеМакета", УПЖКХ_ХранилищеСтруктурыОписанияПараметров, ИмяДокумента));
КонецПроцедуры
