...
Процедура УправлениеФормой(Форма)
	...
	Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.УПЖКХ_ВидыОперацийУчетаДоговоровДПОИ.Заключение") Тогда
		Элементы.ДатаНачалаДействия.Заголовок               = "Дата начала действия";
		Элементы.ПланируемаяДатаОкончанияДействия.Заголовок = "Планируемая дата окончания действия";
		Элементы.ДатаНачалаДействия.Видимость               = Истина;
		Элементы.ОснованиеРасторженияДоговора.Видимость     = Ложь;
	Иначе
		Элементы.ПланируемаяДатаОкончанияДействия.Заголовок = "Дата расторжения";
