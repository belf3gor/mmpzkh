...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	|ИЗ
	|	Документ.КВП_РазовоеНачислениеУслуг КАК Реквизиты
	|ГДЕ
	...
	Реквизиты = Новый Структура("Ссылка,Номер,Дата,Ответственный,Организация,
								|Комментарий,СуммаДокумента, ВидОперации");
