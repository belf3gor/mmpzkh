...
// Обработчик нажатия кнопки "ПечатьФорма13".
//
&НаКлиенте
Процедура ПечатьФорма13(Команда)
	
	ПараметрКоманды = СформироватьСписок("ПФ_MXL_Форма_13");
	
	УПЖКХ_ТиповыеМетодыКлиент.ВыполнитьКомандуПечати("ЖурналДокументов.КВП_УчетДокументовПоМестуЖительства",
														 "ПФ_MXL_Форма_13", ПараметрКоманды,
...
Функция СформироватьСписок(Макет)
	...
	Возврат ЖурналыДокументов.КВП_УчетДокументовПоМестуЖительства.СформироватьИтоговуюТаблицу(Список,
