...
Процедура ПечатьФорма13(Команда)
	...
	УПЖКХ_ТиповыеМетодыКлиент.ВыполнитьКомандуПечати("ЖурналДокументов"
													   + ".КВП_УчетЗаявленийИСвидетельствОРегистрацииПоМестуЖительства",
...
Функция СформироватьСписок()
	...
	Возврат ЖурналыДокументов.КВП_УчетЗаявленийИСвидетельствОРегистрацииПоМестуЖительства.СформироватьИтоговуюТаблицу(Список).ВыгрузитьКолонку("ДокСсылка");
