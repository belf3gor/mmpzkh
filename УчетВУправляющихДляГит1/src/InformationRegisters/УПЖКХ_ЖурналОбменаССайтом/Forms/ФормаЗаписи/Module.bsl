...
&НаКлиенте
// Обработчик нажатия кнопки "Открыть файл обмена".
//
...
Функция ПолучитьСтруктуруСведенийОФайлеОбмена()
	...
	// Ищем запись с файлом в регистре сведений "Журнал обмена".
	СтруктураСведенийОФайле = РегистрыСведений.УПЖКХ_ЖурналОбменаССайтом.ПолучитьСведенияОФайлеОбмена(Запись);
...
Процедура СохранитьФайлОбмена(СохраненныйФайл)
	...
	ИмяФайла = "saveddata_" + Формат(Запись.Дата, "ДФ=дд_ММ_гггг") + "." + РасширениеФайла;
