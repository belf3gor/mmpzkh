...
// Вызывается после запуска конфигурации, открывает окно информации ЖКХ.
Процедура ПоказатьИнформациюПослеЗапускаЖКХ() Экспорт
	ОткрытьФорму("Обработка.КВП_ДополнительнаяИнформация.Форма.ФормаИнформации");
КонецПроцедуры
...
Процедура ПоказатьОповещениеОПроверкеФормул() Экспорт
	
	ИнформацияПриЗапускеКлиент.ОткрытьФормуОповещенияОПроверкеФормул();
	
КонецПроцедуры

Процедура ПоказатьОповещениеОЦентреМониторинга() Экспорт
	
	ИнформацияПриЗапускеКлиент.ОткрытьФормуОповещенияОЦентреМониторинга();
