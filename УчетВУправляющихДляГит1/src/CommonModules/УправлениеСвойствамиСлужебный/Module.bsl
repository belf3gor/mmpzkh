...
Функция ВидыСвойствНабора(Ссылка, УчитыватьПометкуУдаления = Истина) Экспорт
	...
	ВидыСвойствНабора.Вставить(
		...
		// Квартплата +
		// );
		ИЛИ   Метаданные.ОбщиеКоманды.Найти("УПЖКХ_ДополнительныеСведенияКоманднаяПанель") <> Неопределено
		    И Метаданные.ОбщиеКоманды.УПЖКХ_ДополнительныеСведенияКоманднаяПанель.ТипПараметраКоманды.СодержитТип(ТипСсылки));
		// Квартплата -
