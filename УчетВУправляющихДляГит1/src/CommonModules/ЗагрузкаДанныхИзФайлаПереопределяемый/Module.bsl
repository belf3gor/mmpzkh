...
Процедура ПриОпределенииСправочниковДляЗагрузкиДанных(ЗагружаемыеСправочники) Экспорт
	...
	// Используется для загрузки данных в табличные части объектов.
	
	//// Ввод показаний счетчика
	//Сведения = ЗагружаемыеСправочники.Добавить();
	//Сведения.ПолноеИмя = Метаданные.Документы.УПЖКХ_ВводПоказанийСчетчика.ПолноеИмя();
	//Сведения.Представление = Метаданные.Справочники.УПЖКХ_ВводПоказанийСчетчика.Представление();
