...
Функция НаименованиеЭтогоУзлаПоУмолчанию() Экспорт
	...
	Возврат ?(РаботаВМоделиСервиса.РазделениеВключено(), КВП_ПрочиеПроцедурыИФункции.СинонимТиповойКонфигурации(Метаданные.Имя), ОбменДаннымиПовтИсп.ИмяЭтойИнформационнойБазы());
	// Квартплата -
