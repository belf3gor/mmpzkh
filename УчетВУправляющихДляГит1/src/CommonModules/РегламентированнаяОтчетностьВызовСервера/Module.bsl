...
Функция СвойстваВнешнегоОтчета(ОбъектЭлемент, Отчет) Экспорт
	...
	СвойстваОтчета.Вставить("ИДКонфигурацииМетаданные", КВП_ПрочиеПроцедурыИФункции.НаименованиеТиповойКонфигурации(Метаданные.Имя));
	// Квартплата -
	...
	СвойстваОтчета.Вставить("ВерсияКонфигурацииМетаданные", КВП_ПрочиеПроцедурыИФункции.НомерВерсииТиповойКонфигурации(Метаданные.Версия));
	// Квартплата -
