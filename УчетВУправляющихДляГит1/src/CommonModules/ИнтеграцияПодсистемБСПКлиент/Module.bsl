...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	// Квартплата +
	// До обновления информационной базы (как БП, так и ЖКХ) для критичных версий проверяем наличие архивной копии.
	Параметры.Модули.Добавить(Новый Структура("Модуль, Номер", УПЖКХ_ОбновлениеИнформационнойБазыКлиент, 4));
	// Квартплата -
	
	// Квартплата +
	// До обновления информационной базы (как БП, так и ЖКХ) проверяем наличие лицензии.
	Параметры.Модули.Добавить(Новый Структура("Модуль, Номер", УПЖКХ_ОбновлениеИнформационнойБазыКлиент, 5));
	// Квартплата -
	
	// Обновление информационной базы.
	// Квартплата +
	// Параметры.Модули.Добавить(Новый Структура("Модуль, Номер", ОбновлениеИнформационнойБазыКлиент, 4));
	Параметры.Модули.Добавить(Новый Структура("Модуль, Номер", ОбновлениеИнформационнойБазыКлиент, 6));
	// Квартплата -
	...
	Параметры.Модули.Добавить(Новый Структура("Модуль, Номер", ОбновлениеИнформационнойБазыКлиент, 7));
	// Квартплата -
