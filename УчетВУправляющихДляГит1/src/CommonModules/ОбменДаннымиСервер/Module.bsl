...
Функция ПараметрыИнформационнойБазы(Знач ИмяПланаОбмена, Знач КодУзла, СообщениеОбОшибке) Экспорт
	...
	Результат.ВерсияКонфигурации                   = КВП_ПрочиеПроцедурыИФункции.НомерВерсииТиповойКонфигурации(Метаданные.Версия);
	// Квартплата -
	...
	Результат.НаименованиеИнформационнойБазыПоУмолчанию = ?(ОбщегоНазначенияПовтИсп.РазделениеВключено(),
		КВП_ПрочиеПроцедурыИФункции.СинонимТиповойКонфигурации(Метаданные.Имя), ОбменДаннымиПовтИсп.ИмяЭтойИнформационнойБазы());
	// Квартплата -
