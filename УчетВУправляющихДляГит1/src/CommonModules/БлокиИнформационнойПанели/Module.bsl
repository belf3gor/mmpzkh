...
Функция ПредопределенныеБлоки() Экспорт
	...
	// Квартплата +
	ДобавитьПоддержкаИОбслуживание(ТаблицаБлоков);
	// Квартплата -
...
// Добавляет предопределенный блок "ПоддержкаИОбслуживание".
//
Процедура ДобавитьПоддержкаИОбслуживание(ТаблицаБлоков)
	
	Добавить(ТаблицаБлоков,
			"УПЖКХ_ПоддержкаИОбслуживание",
			НСтр("ru = 'Поддержка и обслуживание'"),
			"БлокиИнформационнойПанели.УПЖКХ_ПоддержкаИОбслуживание",
			,
			СвойстваПоддержкаИОбслуживание());
	
КонецПроцедуры // ДобавитьПоддержкаИОбслуживание()

// Возвращает наименование реквизита заголовка блока.
//
Функция СвойстваПоддержкаИОбслуживание()
	
	Возврат "УПЖКХ_ПоддержкаИОбслуживание_Заголовок";
	
КонецФункции // СвойстваПоддержкаИОбслуживание()
...
//     * АдресХранилища - Строка - адрес хранилища результата.
//
Процедура УПЖКХ_ПоддержкаИОбслуживание(Параметры) Экспорт
	
	Результат = Новый Структура(СвойстваПоддержкаИОбслуживание());
	Результат.Вставить("УПЖКХ_ПоддержкаИОбслуживание_Заголовок",
		ЗаголовокБлока(НСтр("ru = 'Поддержка и обслуживание'")));
	
	ПоместитьВоВременноеХранилище(Результат, Параметры.АдресХранилища);
	
КонецПроцедуры // УПЖКХ_ПоддержкаИОбслуживание()
// Квартплата -
