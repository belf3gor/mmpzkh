...
Функция ДанныеФизическихЛиц(Организация = Неопределено, ФизическиеЛица, ДатаСреза, ФИОКратко = Истина, РезультатТаблично = Ложь) Экспорт
	...
	// Квартплата +
	Если РезультатТаблично Тогда
		ТабРезультат.Колонки.Добавить("ДатаВступленияПоследнегоИмени");
	Иначе
		Результат.Вставить("ДатаВступленияПоследнегоИмени");
	КонецЕсли;
	// Квартплата -
	...
	Для Каждого ФизическоеЛицо ИЗ СписокФизическихЛиц Цикл
		...
		// Квартплата +
		Результат.ДатаВступленияПоследнегоИмени = ДанныеФизЛиц.Период;
		// Квартплата -
