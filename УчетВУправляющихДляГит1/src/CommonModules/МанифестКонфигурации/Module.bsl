...
Функция СформироватьМанифестКонфигурации() Экспорт
	...
	Манифест.Name = КВП_ПрочиеПроцедурыИФункции.НаименованиеТиповойКонфигурации(Метаданные.Имя);
	Манифест.Presentation = КВП_ПрочиеПроцедурыИФункции.СинонимТиповойКонфигурации(Метаданные.Имя);
	Манифест.Version = КВП_ПрочиеПроцедурыИФункции.НомерВерсииТиповойКонфигурации(Метаданные.Версия);
	// Квартплата +
