...
#Область ProductVersion
		...
		Версия = КВП_ПрочиеПроцедурыИФункции.НомерВерсииТиповойКонфигурации(Метаданные.Версия);
		// Квартплата -
		МассивСлов = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивСлов(Версия, ".");
		// Версия должна быть в формате "99.99.999.9999".
		Пока МассивСлов.Количество() < 4 Цикл
...
#Область МетаданныеИмя
		...
		Результат = КВП_ПрочиеПроцедурыИФункции.НаименованиеТиповойКонфигурации(Метаданные.Имя);
		// Квартплата -
...
#Область МетаданныеВерсия
		...
		Результат = КВП_ПрочиеПроцедурыИФункции.НомерВерсииТиповойКонфигурации(Метаданные.Версия);
		// Квартплата -
