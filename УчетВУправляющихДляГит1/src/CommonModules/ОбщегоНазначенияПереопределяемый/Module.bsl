...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	// Квартплата +
	// Установка параметра сеанса для мониторинга системы лицензирования СЛК.
	Обработчики.Вставить("СЗК_ОшибкаПолученияЛицензииПриПоследнейПроверке", "СЗК_ТиповыеМетоды.УстановитьПараметрСеансаПоследнегоРезультатаПроверкиВЗначениеПоУмолчанию");
	// Квартплата -
...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	Библиотека = КВП_ПрочиеПроцедурыИФункции.НаименованиеТиповойКонфигурации(Метаданные.Имя);
	// Квартплата -
