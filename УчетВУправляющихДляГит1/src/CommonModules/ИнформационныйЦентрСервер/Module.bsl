...
Функция ОпределитьМассивТехническихПараметров(ДополнительныеПараметры)
	...
	МассивПараметров.Добавить(Новый Структура("Имя, Значение", "ИмяКонфигурации",    КВП_ПрочиеПроцедурыИФункции.НаименованиеТиповойКонфигурации(Метаданные.Имя)));
	МассивПараметров.Добавить(Новый Структура("Имя, Значение", "ВерсияКонфигурации", КВП_ПрочиеПроцедурыИФункции.НомерВерсииТиповойКонфигурации(Метаданные.Версия)));
	// Квартплата -
